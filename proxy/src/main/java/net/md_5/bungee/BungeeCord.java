...
public class BungeeCord extends ProxyServer {
            ...
            ChannelFutureListener listener = new ChannelFutureListener() {
                ...
                public void operationComplete(ChannelFuture future) throws Exception {
                    if (future.isSuccess()) {
                        ...
                        System.out.println(" ");
                        getLogger().log(Level.INFO, ChatColor.BLUE + "Listening on server: " + ChatColor.AQUA + "{0}", info.getHost());
                        getLogger().info(ChatColor.YELLOW + "Proxy ready!");
                        System.out.println(" ");
                    } else {
                        getLogger().log(Level.WARNING, ChatColor.RED + "Could not bind to host " + info.getHost(), future.cause());
                    }
                }
            };
            new ServerBootstrap()
    ...
    public void stop(final String reason) {
        new Thread("Shutdown Thread") {
            ...
            public void run() {
                ...
                getLogger().info(ChatColor.RED + "Closing proxy...");
                ...
                getLogger().info(ChatColor.GOLD + "[>] Disabling plugins... [<]");
                ...
                getLogger().info(ChatColor.YELLOW + "Proxy has been closed!");
    ...
    @Override
    public ServerInfo constructServerInfo(String name, InetSocketAddress address, String motd, boolean restricted, boolean supported1_9) {
        return new BungeeServerInfo(name, address, motd, restricted, supported1_9);
    }
